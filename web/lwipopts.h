...
#define INCLUDE_HTTPD_POST
//#define INCLUDE_HTTPD_CGI
#define INCLUDE_HTTPD_SSI
#define INCLUDE_HTTPD_SSI_TAG
...
#define X32_F "x"
#endif
extern int uUartsprintf(const char *pcString, ...);
#define LWIP_DEBUG
...
#define LWIP_DBG_TYPES_ON               LWIP_DBG_ON //(LWIP_DBG_ON|LWIP_DBG_TRACE|LWIP_DBG_STATE|LWIP_DBG_FRESH)
...
#define SSDP_DEBUG                      LWIP_DBG_OFF
#define CGI_GeneralSetting_TEST         LWIP_DBG_ON
#define CGI_InOutputSetting_TEST        LWIP_DBG_ON


#define CGI_TEST                        LWIP_DBG_ON
#define CGI_HOME                        LWIP_DBG_ON
#endif
